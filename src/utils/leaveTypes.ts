...
LEAVE_TYPE_MAP['concediu_fara_plata'] = LEAVE_TYPE_MAP['cs'];
LEAVE_TYPE_MAP['concediu_crestere_copil'] = LEAVE_TYPE_MAP['cs'];
LEAVE_TYPE_MAP['cfp'] = LEAVE_TYPE_MAP['cs'];
LEAVE_TYPE_MAP['ccc'] = LEAVE_TYPE_MAP['cs'];

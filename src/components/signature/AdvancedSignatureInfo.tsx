        ...
        {showIntegrationOptions && (
          <>
            ...
            <div className="flex items-start gap-3 p-3 bg-warning/10 rounded-lg border border-warning/20">
              <FileSignature className="w-5 h-5 text-warning flex-shrink-0 mt-0.5" />
              <div className="text-sm">
                <p className="font-medium text-foreground mb-1">
                  Integrare în curs de dezvoltare
                </p>
                <p className="text-muted-foreground">
                  Pentru a utiliza semnătura electronică calificată, contactați departamentul IT 
                  pentru a solicita un certificat digital de la unul dintre furnizorii acreditați.
                </p>
              </div>
            </div>
          </>

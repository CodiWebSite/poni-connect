...
export function LeaveRequestDocument({
  ...
  return (
    <div className="bg-white p-4 sm:p-8 rounded-lg border shadow-sm text-black print:shadow-none print:border-none overflow-x-auto" style={{ fontFamily: 'Times New Roman, serif' }}>
      ...
      {/* Anexa - right aligned */}
      <div className="text-right text-[10px] sm:text-xs mb-4 sm:mb-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between mb-6 sm:mb-8 px-2 sm:px-4 gap-4 sm:gap-0">
        <div className="text-center">
          <p className="text-xs sm:text-sm mb-1">Se aprobă,</p>
          <p className="text-[10px] sm:text-xs text-gray-600 mb-2">Aprobat, DIRECTOR</p>
          <div className="w-28 sm:w-36 h-16 sm:h-20 border-b-2 border-gray-400 flex items-end justify-center pb-1 mx-auto">
            {directorApproved && (
              <span className="text-green-700 text-xs sm:text-sm font-semibold">✓ APROBAT</span>
            )}
          </div>
        </div>
        <div className="text-center">
          <p className="text-xs sm:text-sm mb-2 sm:mb-3">Șef compartiment</p>
      ...
      {/* Title */}
      <h1 className="text-center text-lg sm:text-xl font-bold mb-6 sm:mb-8 underline">Cerere concediu odihnă</h1>

      {/* Body */}
      <div className="space-y-4 sm:space-y-6 text-xs sm:text-sm leading-6 sm:leading-7 px-2 sm:px-4">
        <p className="text-sm sm:text-base">Doamnă/Domnule Director,</p>
        ...
        <p className="mt-4 sm:mt-6">Cu mulţumiri,</p>
      </div>
      ...
      <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row justify-between items-start sm:items-end px-2 sm:px-4 gap-4 sm:gap-0">
        <div>
          <p className="text-xs sm:text-sm font-semibold border-b border-black px-1 inline-block">{employeeName || '________________________'}</p>
        </div>
        <div className="text-center">
          <div className="w-36 sm:w-44 h-20 sm:h-24 border-2 border-gray-300 rounded flex items-center justify-center overflow-hidden bg-gray-50 mb-1">
            {employeeSignature ? (
              ...
              <span className="text-gray-400 text-[10px] sm:text-xs italic">Semnătura angajat</span>
            )}
          </div>
      ...
      {/* HR Section */}
      <div className="mt-8 sm:mt-12 pt-4 sm:pt-6 border-t-2 border-dashed border-gray-400 px-2 sm:px-4">
        <h2 className="font-bold text-sm sm:text-base mb-3 sm:mb-4">Propunem să aprobaţi,</h2>
        
        <p className="text-justify text-xs sm:text-sm leading-6 sm:leading-7">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mt-6 sm:mt-8 gap-4 sm:gap-0">
          <div>
            <p className="text-[10px] sm:text-xs text-gray-600 mb-1">___________________</p>
            <p className="text-[10px] sm:text-xs italic">(numele salariatului de la SRUS)</p>
            {hrOfficerName && <p className="mt-1 font-semibold text-xs sm:text-sm">{hrOfficerName}</p>}
          </div>
          <div className="text-center">
            <p className="text-[10px] sm:text-xs text-gray-600 mb-1">_______________</p>
            <p className="text-[10px] sm:text-xs italic">(semnătura)</p>
          </div>
        </div>
      </div>
    </div>

...
const templates: Template[] = [
  ...
  { name: 'Declarație deducere suplimentară minori aflați în întreținerea contribuabilului', filename: 'Declaratie_deducere_suplimentara_minori_aflati_in_intretinerea_contribuabilului.docx', category: 'Declarații' },
  { name: 'Declarație persoane majore în întreținerea contribuabilului', filename: 'Declaratie_persoane_majore_in_intretinerea_contribuabilului.doc', category: 'Declarații' },
  { name: 'Model declarație salar minim', filename: 'Model_declaratie_salar_minim.doc', category: 'Declarații' },

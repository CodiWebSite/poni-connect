...
const DoctoralDashboard = () => {
  ...
  return (
    <MainLayout title="Spațiul Doctoral"><div className="mx-auto max-w-7xl px-4 py-6 sm:px-6">
      ...
      <Tabs defaultValue="journey"><TabsList className="mb-5 h-auto flex-wrap"><TabsTrigger value="journey">Parcurs și termene</TabsTrigger><TabsTrigger value="documents">{isManager ? "Documente" : "Documentele mele"}</TabsTrigger></TabsList>

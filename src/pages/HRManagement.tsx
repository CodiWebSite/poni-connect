  ...
  return (
    <MainLayout title="Gestiune HR" description="Centru Profesionist de Administrare Personal">
      <Tabs defaultValue="dashboard" className="space-y-6">
        ...
        <TabsContent value="reports"><HRReportsPanel employees={employees.map(e => ({ id: e.id, full_name: e.full_name, email: e.email, department: e.department, position: e.position, grade: e.grade, employment_date: e.employment_date, contract_type: e.contract_type, total_leave_days: e.total_leave_days, used_leave_days: e.used_leave_days, hasAccount: e.hasAccount, leaveHistory: e.leaveHistory, carryoverDays: e.carryoverDays, bonusDays: e.bonusDays }))} archivedEmployees={archivedEmployees.map(e => ({ id: e.id, full_name: e.full_name, email: e.email, department: e.department, position: e.position, grade: e.grade, employment_date: e.employment_date, contract_type: e.contract_type, total_leave_days: e.total_leave_days, used_leave_days: e.used_leave_days, hasAccount: e.hasAccount, leaveHistory: e.leaveHistory, carryoverDays: e.carryoverDays, bonusDays: e.bonusDays }))} /></TabsContent>

        <TabsContent value="certificates"><CertificateGenerator employees={employees.map(e => ({ id: e.id, full_name: e.full_name, email: e.email, department: e.department, position: e.position, grade: e.grade, employment_date: e.employment_date, contract_type: e.contract_type, total_leave_days: e.total_leave_days, used_leave_days: e.used_leave_days, hasAccount: e.hasAccount }))} /></TabsContent>

        <TabsContent value="dossier"><EmployeeDigitalDossier employees={employees.map(e => ({ id: e.id, full_name: e.full_name, email: e.email, department: e.department, position: e.position, employee_record_id: e.employee_record_id, user_id: e.user_id }))} /></TabsContent>
      </Tabs>
    </MainLayout>
  );
};
